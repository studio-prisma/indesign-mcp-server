...
export function formatObject({
  ...
  // Weight before colour. The other order loses both: a strokeWeight
  // assignment made after the colour pulls the item defaults back, and the
  // object keeps the stroke it had. Reproduced on rectangles, polygons and
  // text frames in 21.5, which is why the two blocks are in this sequence.
